	...
	<div class="invoice">
		<transition name="fade" mode="out-in" v-on:enter="enter">
			<div key="list" class="page-show" v-if="visibleList">
				<content-title>发票项目管理</content-title>
			  <el-form :inline="true" :model="queryData" size="small">
			  	<el-form-item label="发票项目名称">
			      <el-input v-model="queryData.name" placeholder="发票项目名称"></el-input>
			    </el-form-item>
		    ...
		    <el-table :data="tablePageData" border highlight-current-row style="width: 100%" align='center' size="small">
		      ...
		      <el-table-column prop="name" label="发票项目名称" align="center" min-width="60" show-overflow-tooltip></el-table-column>
		  ...
		  <div key="edit" class="page-show" v-else>
		  	<content-title>发票项目管理详情</content-title>
...
<script>
  import InvoiceJs from './Invoice.js'

  export default InvoiceJs
</script>
