	...
	<div class="department">
		<transition name="fade" mode="out-in" v-on:enter="enter">
			<div key="list" class="page-show" v-if="visibleList">
		      ...
		      <el-table-column prop="name" label="体检科室名称" align="center" min-width="100"></el-table-column>
		      <el-table-column prop="type" label="体检科室类型" align="center" min-width="130" :formatter="formatterType"></el-table-column>
		      <el-table-column prop="isenabled" label="是否允许一个项目多个诊断" align="center" min-width="100" :formatter="formatterWhether"></el-table-column>
		      <el-table-column prop="lastaccount" label="最后修改账户" align="center" min-width="100"></el-table-column>
		      <el-table-column prop="lasttime" label="最后修改时间" align="center" min-width="100"></el-table-column>
