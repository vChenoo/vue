<template>
  <div class="systemlog">
    <content-title>操作日志</content-title>
    ...
    <div key="list" class="page-show">
      <el-table :data="tablePageData" border highlight-current-row style="width: 100%" align='center' size="small">
        ...
        <el-table-column prop="account" label="操作账号" align="center" min-width="60" show-overflow-tooltip></el-table-column>
        <el-table-column prop="name" label="操作员工" align="center" min-width="60" show-overflow-tooltip></el-table-column>
        <el-table-column prop="type" label="操作类型" align="center" min-width="40" :formatter="formatterType" show-overflow-tooltip></el-table-column>
        <el-table-column prop="date" label="操作时间" align="center" min-width="60" sortable="true" show-overflow-tooltip></el-table-column>
        <el-table-column prop="content" label="操作内容" align="center" min-width="80" show-overflow-tooltip></el-table-column>
        <el-table-column prop="number" label="体检编号" align="center" min-width="60" show-overflow-tooltip></el-table-column>
        <el-table-column prop="ipaddress" label="操作IP" align="center" min-width="60" show-overflow-tooltip></el-table-column>
      </el-table>
