	...
	<div class="sample">
		<transition name="fade" mode="out-in" v-on:enter="enter">
			<div key="list" class="page-show" v-if="visibleList">
				<content-title>标本类型管理</content-title>
		    ...
		    <el-table :data="tablePageData" border highlight-current-row style="width: 100%" align='center' size="small">
		      ...
		      <el-table-column prop="name" label="标本类型名称" align="center" min-width="100" show-overflow-tooltip></el-table-column>
		      ...
		      <el-table-column prop="lasttime" label="最后修改时间" align="center" min-width="100" show-overflow-tooltip></el-table-column>
		  ...
		  <div key="edit" class="page-show" v-else>
		  	<content-title>标本类型管理详情</content-title>
