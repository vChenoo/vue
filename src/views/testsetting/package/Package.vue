	...
	<div class="package">
		<transition name="fade" mode="out-in" v-on:enter="enter">
			<div key="list" class="page-show" v-if="visibleList">
				<content-title>体检套餐</content-title>
		      ...
		      <el-table-column prop="name" label="体检套餐名称" align="center" min-width="60" show-overflow-tooltip></el-table-column>
		      <el-table-column prop="shorthand" label="套餐简称" align="center" min-width="50" show-overflow-tooltip></el-table-column>
		      <el-table-column prop="testtype" label="体检类别" align="center" min-width="65" :formatter="formatterType"show-overflow-tooltip></el-table-column>
		      <el-table-column prop="originalprice" label="标准价格" align="center" min-width="50"></el-table-column>
			...
			<div key="edit" class="page-show" v-else>
				<content-title>体检套餐详情</content-title>
		      ...
		      <div class="group">
		      	...
		      	<el-form-item label="组合项目" prop="groupproject">
		      		<template>
		      			<el-select v-model="formTemp.groupproject" value-key="code" multiple filterable size="medium" placeholder="请选择套餐内包含的组合项目">
		      				<el-option v-for="item in groupOption" :key="item.code" :label="item.name" :value="item">
