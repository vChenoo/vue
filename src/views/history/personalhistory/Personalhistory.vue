	...
	<div class="personalhistory">
		<transition name="fade" mode="out-in" v-on:enter="enter">
			<div key="list" class="page-show" v-if="visibleList===1">
				<content-title>个人体检转档记录</content-title>
		      ...
		      <el-table-column prop="code" label="体检编号" align="center" min-width="60" show-overflow-tooltip></el-table-column>
		      <el-table-column prop="times" label="第几次体检" align="center" min-width="40"></el-table-column>
		      <el-table-column prop="prepareid" label="预约编号" align="center" min-width="60" show-overflow-tooltip></el-table-column>
		      ...
		      <el-table-column prop="org" label="体检单位" align="center" min-width="60" :formatter="formatterOrg"  show-overflow-tooltip></el-table-column>
		      <el-table-column prop="testtype" label="体检类别" align="center" min-width="60" :formatter="formatterType" show-overflow-tooltip></el-table-column>
		      <el-table-column prop="date" label="体检日期" align="center" min-width="60" show-overflow-tooltip></el-table-column>
		      <el-table-column prop="idcard" label="身份证号" align="center" min-width="80" show-overflow-tooltip></el-table-column>
		      <el-table-column prop="istotal" label="是否已总检" align="center" min-width="40" :formatter="formatterWhether"></el-table-column>
		      <el-table-column label="操作" min-width="190" align='left' header-align="center">
            <template slot-scope="scope">
            	<el-button class="op-mini" type="primary" size="mini" @click="handleInfo(scope.row, scope.$index)">详情</el-button>
              <el-button class="op-mini" type="primary" size="mini" @click="handleFiled">转档回撤</el-button>
			...
			<div key="info" class="page-show" v-else-if="visibleList===2">
				<content-title>个人体检转档记录详情</content-title>
				<div class="top-back">
...
<script>
  import PersonalhistoryJs from './Personalhistory.js'

  export default PersonalhistoryJs
</script>
