	...
	<div class="othercharges">
		<transition name="fade" mode="out-in" v-on:enter="enter">
			<div key="list" class="page-show" v-if="visibleList">
				<content-title>相关收费项目管理</content-title>
		    ...
		    <el-table :data="tablePageData" border highlight-current-row style="width: 100%" align='center' size="small">
		      ...
		      <el-table-column prop="name" label="相关收费项目名称" align="center" min-width="80" show-overflow-tooltip></el-table-column>
		      <el-table-column prop="collect" label="汇总项目" align="center" min-width="60" :formatter="formatterCollect" show-overflow-tooltip></el-table-column>
		  ...
		  <div key="edit" class="page-show" v-else>
		  	<content-title>相关收费项目管理详情</content-title>
